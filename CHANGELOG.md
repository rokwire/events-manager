...
## [Unreleased]
### Added
- Location Label changed to Location Address + Virtual event checkbox moved down(Task_1 and Task_2 of issue). [#636](https://github.com/rokwire/events-manager/issues/636)
